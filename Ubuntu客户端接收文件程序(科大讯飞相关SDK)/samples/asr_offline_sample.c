...
extern int client_link_server();
extern void client_recvfile();
extern void client_close();
extern void send_data(char *buf);
...
{
	const char *login_config    = "appid = 5b56c9ad"; //登录参数
	UserData asr_data; 
	int ret                     = 0 ;
	char c;
	...
	// 客户端连接服务器
	int sta_ret = client_link_server();
